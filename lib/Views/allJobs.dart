...
class allJobsScreen extends StatefulWidget {
  const allJobsScreen({super.key, required this.title});

  final String title;

  @override
  State<allJobsScreen> createState() => allJobsScreenPageState();
}

class allJobsScreenPageState extends State<allJobsScreen> {
      ...
      body: FutureBuilder<List<JobModel>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(
              child: Text('שגיאה, נסה שוב', style: TextStyle(
            ...
            return Center(
              child: Text(
                  'אין תוצאות', style: TextStyle(fontSize: 23, color: Theme
                  .of(context)
                  .colorScheme
                  .onBackground)),
            );
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              JobDetails2Screen(title: "Job Details", jb: job),
                        ),
                      );
                    },
                  ),
  ...
  Future<List<JobModel>> getJobs() async {
    ...
    var url = "/Job/getAllJobs.php?companyID=$ffg";
